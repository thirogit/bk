...
class FstOwnerHentIntegritySolution : public Solution
{
public:
	FstOwnerHentIntegritySolution(SolutionType type, const PurchaseObjPath& path ,const IPurchaseHent* problemHent, const IPurchaseHent* fixHent);
