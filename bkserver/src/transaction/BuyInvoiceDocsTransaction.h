...
class BuyInvoiceDocsTransaction : public IClientTransaction, protected InvoiceTransactionSkeleton
{	
public:
	BuyInvoiceDocsTransaction(ISeasonInterface* pInterface,uint32_t transactionId);	
