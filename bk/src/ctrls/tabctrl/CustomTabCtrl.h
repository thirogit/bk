...
#define CTCN_TABSELECTED		NM_FIRST
...
#define CTCN_TABUNSELECTED		NM_FIRST + 5
...
public:
	...
	INT_PTR						GetItemCount() {return m_aItems.GetSize();}
	int							GetCurSel() { return m_nItemSelected; }
	int							SetCurSel(int nItem,BOOL bNotify = FALSE);
