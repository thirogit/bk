#ifndef __STATICLISTCTRL_H__
#define __STATICLISTCTRL_H__

#include <afxwin.h>
#include "../expandablelist/ListHeaderDescriptor.h"
#include "../expandablelist/ListHeaderLayout.h"
#include "../expandablelist/ListRow.h"
#include <vector>
#include <set>
...
class CStaticListCtrl : public COwnClassWnd
{
	struct CHeader : public CStatic
	{
		CStaticListCtrl* m_parent;
