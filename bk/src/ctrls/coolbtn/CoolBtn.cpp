...
BOOL CCoolBtn::SetButtonImage(UINT nResourceId, COLORREF crMask)
{
  ...
  if( m_bLoaded ) {
	...
	m_IL.Create( m_bm.bmWidth, m_bm.bmWidth , ILC_COLORDDB | ILC_MASK ,  1 , 1 );
	m_IL.Add( &m_btnImage , crMask );
...
//
////////////////////////////////////////////////////////////////////////////////
BOOL CCoolBtn::AddMenuItem(UINT nMenuId, LPCTSTR sItemText, UINT nMenuFlags)
{
	BOOL bRet = m_menu.AppendMenu(nMenuFlags | MF_STRING, nMenuId, sItemText);
...
//
////////////////////////////////////////////////////////////////////////////////
BOOL CCoolBtn::RemoveMenuItem(UINT nMenuId,UINT nMenuFlags)
{
...
void CCoolBtn::EnableMenu(BOOL bEnable)
{
