...
/*============================================================================*/
// CMFCXStatusBar window

class CMFCXStatusBar : public CPane
{
	DECLARE_DYNAMIC(CMFCXStatusBar)
...
protected:
	...
	inline CMFCXStatusBarPaneInfo* _GetPanePtr(int nIndex) const;
	CMFCXStatusBarPaneInfo* HitTest(CPoint pt) const;

	HFONT GetCurrentFont() const;

// Overrides:
protected:
	virtual void OnDrawPane(CDC* pDC, CMFCXStatusBarPaneInfo* pPane);
