...
int XStatusBar::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
LRESULT XStatusBar::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void XStatusBar::RepositionControls()
{
...
BOOL XStatusBar::AddPaneControl(HWND hWnd, UINT nID, BOOL bAutoDestroy)
{
	if (CommandToIndex (nID) == -1) {
		return FALSE;
	}
...
BOOL XStatusBar::PaneInfoGet(int nIndex, _STATUSBAR_PANE_* pPane)
{
...
BOOL XStatusBar::PaneInfoSet(int nIndex, _STATUSBAR_PANE_* pPane)
{
	if( nIndex < m_nCount  && nIndex >= 0 ){
