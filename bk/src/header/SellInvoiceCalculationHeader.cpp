#include "stdafx.h"
#include "SellInvoiceCalculationHeader.h"
#include "../utils/StringLoader.h"
#include "../resource.h"
#include "../invoice/view/CalculationElementView.h"

SellInvoiceCalculationHeader::SellInvoiceCalculationHeader()
{
	operator()  (CalculationElementViewMember::CalculationElementView_HasTerm,L"*")
				...
				(CalculationElementViewMember::CalculationElementView_OtherHent,StringLoader(IDS_HEADER_BUYFROMHENT))
				(CalculationElementViewMember::CalculationElementView_OtherPrice,StringLoader(IDS_HEADER_BUYPRICE))
