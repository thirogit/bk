...
SellInvoice::SellInvoice(uint32_t id,InvoiceScope scope) : InvoiceTemplate<ISellInvoice>(id,scope)
{
}

InvoiceDirection SellInvoice::GetInvoiceDirection() const
{
	return InvoiceDirection_Sell;
}

SellInvoice* SellInvoice::Clone() const
{
	SellInvoice* pClone = new SellInvoice(GetId(), GetInvoiceScope());
...
json::value SellInvoice::ToJson() const
{
	json::value result;
