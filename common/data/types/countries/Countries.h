...
struct tag_CountriesException{};

typedef TagException<tag_CountriesException> CountriesException;
...
{		
	...
	<
	  ...
	  boost::multi_index::indexed_by< 
										...
										boost::multi_index::ordered_unique < boost::multi_index::tag<index_tag_code2a>, boost::multi_index::const_mem_fun<Country,std::wstring, &Country::GetCountryCode2A> >
									>
	> CountriesIndex;
...
public:
	...
	static const Country GetCountryByCode2a(const std::wstring& code2a);	
